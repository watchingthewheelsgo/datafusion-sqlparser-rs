...
pub use self::query::{
    ...
    SelectItemQualifiedWildcardKind, SetExpr, SetOperator, SetQuantifier, Setting, SortByExpr,
    SortByOptions, SymbolDefinition, Table, TableAlias, TableAliasColumnDef, TableFactor,
